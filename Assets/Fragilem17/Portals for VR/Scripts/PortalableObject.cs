...
namespace Fragilem17.MirrorsAndPortals
{
    ...
    public class PortalableObject : MonoBehaviour
    {
        ...
        public int _framesSinceLastPortal = 99;
        ...
        {
            if (_framesSinceLastPortal < int.MaxValue)
            {
                _framesSinceLastPortal++;
            }
            else
            {
                _framesSinceLastPortal = 99; // Or handle overflow as needed
            }
		...
		public virtual bool CanPortal() {
            ...
            return (!childOfAnotherPortalable && PortallingEnabled && !PortalAlongWithMasterPortalable && _framesSinceLastPortal > 4f);
        }
